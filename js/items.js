...
const TOYS = {
    ...
    paddleBall: {
        name: "Paddle Ball",
        value: 20,
        image: "../assets/toy/paddleball.png",
    },
    teddyBear: {
        name: "Teddy Bear",
        value: 20,
        image: "../assets/toy/teddy_bear.png",
    },
    musicBox: {
        name: "Music Box",
        value: 20,
        image: "../assets/toy/music_box.png",
    },
};
...
const PETS = {
    daisy: {
        ...
        stages: {
            stage1: [
                "../assets/daisy/stage1a.png",
                "../assets/daisy/stage1b.png",
            ],
            stage2: [
                "../assets/daisy/stage2a.png",
                "../assets/daisy/stage2b.png",
            ],
            stage3: [
                "../assets/daisy/stage3a.png",
                "../assets/daisy/stage3b.png",
            ],
    ...
    spike: {
        ...
        stages: {
            stage1: [
                "../assets/spike/stage1a.png",
                "../assets/spike/stage1b.png",
            ],
            stage2: [
                "../assets/spike/stage2a.png",
                "../assets/spike/stage2b.png",
            ],
            stage3: [
                "../assets/spike/stage3a.png",
                "../assets/spike/stage3b.png",
            ],
            dead: "../assets/dead.png",
        },
    },
    lily: {
        ...
        stages: {
            stage1: [
                "../assets/lily/stage1a.png",
                "../assets/lily/stage1b.png",
            ],
            stage2: [
                "../assets/lily/stage2a.png",
                "../assets/lily/stage2b.png",
            ],
            stage3: [
                "../assets/lily/stage3a.png",
                "../assets/lily/stage3b.png",
            ],
            dead: "../assets/dead.png",
        },
    },
